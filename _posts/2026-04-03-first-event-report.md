...
- 静岡の女性Pythonista（= Python 利用者）を繋ぎ、輪を広げていきたい
- 初心者・熟練者は問いません。  
Python でコードを書いたことがない方でも、Python に興味があればお気軽にご参加ください。  
（Python を用いた初心者向けイベントも企画予定です）
...
※PyLadies Shizuokaだけではなく、東京をはじめ、日本全国の女性Pythonistaとコミュニケーションとることも出来ます！
